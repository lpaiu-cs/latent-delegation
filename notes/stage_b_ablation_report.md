...
- bridge_only: hidden_mse_mean=20.535807, hidden_mse_std=0.287934, cosine_mean=0.800323, cosine_std=0.003365, gate_value_mean=0.071615, delta_norm_mean=1300.676524
- bridge_only_param_matched: hidden_mse_mean=20.880208, hidden_mse_std=0.313118, cosine_mean=0.797765, cosine_std=0.003324, gate_value_mean=0.071940, delta_norm_mean=1245.829941
- hybrid_no_small: hidden_mse_mean=23.601562, hidden_mse_std=0.438480, cosine_mean=0.781677, cosine_std=0.002479, gate_value_mean=0.074870, delta_norm_mean=798.720241
- hybrid: hidden_mse_mean=21.068359, hidden_mse_std=0.235568, cosine_mean=0.809565, cosine_std=0.003184, gate_value_mean=0.071289, delta_norm_mean=1485.074935
...
6. Is the delegated path actually used, based on gate and delta diagnostics? Yes. Hybrid gate mean=0.071289, hybrid delta_norm_mean=1485.074935, and hybrid vs gate-zero gains are mse=4.441406, cosine=0.063461.
