param(
    ...
    [string]$OutputDir = "outputs/adaptive_bridge/route_ablation",
    [string]$ResultsPath = "outputs/adaptive_bridge/route_ablation/results.json"
)
...
py -3.12 -m src.adaptive_bridge.route_ablation `
    --config $Config `
    --train-dir $TrainDir `
